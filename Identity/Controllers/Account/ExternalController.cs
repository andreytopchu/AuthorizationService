...
namespace Identity.Controllers.Account
{
    ...
    public class ExternalController : Controller
    {
        ...
        public async Task<IActionResult> Callback()
        {
            ...
            await _events.RaiseAsync(new UserLoginSuccessEvent(provider, providerUserId, user.Subject, user.Name, true,
            ...
            FindUserFromExternalProvider(AuthenticateResult result)
        {
            ...
            // find external user
            var user = _userStoreService.FindByExternalProvider(providerUserId, provider!).Result;
