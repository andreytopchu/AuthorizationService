...
namespace Identity.Controllers.Admin
{
    ...
    public class RoleController : BaseController
    {
        ...
        /// <summary>
        /// Список доступных полиси для настройки ролей
        /// </summary>
        /// <param name="roleReadRepository">Репозиторий для чтения ролей</param>
        /// <param name="cancellation"></param>
        /// <returns>Коллекция полиси</returns>
        ...
        public async Task<IActionResult> GetPolicies(IRoleReadRepository roleReadRepository, CancellationToken cancellation)
        {
            if (roleReadRepository == null) throw new ArgumentNullException(nameof(roleReadRepository));

            return Ok( /*await roleReadRepository.GetPolicies(cancellation)*/);
        }
    }
}